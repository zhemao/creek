...
alias com {
  ...
  vlog -sv "+incdir+$QSYS_SIMDIR/fpga_ddr3/" "$QSYS_SIMDIR/fpga_ddr3/alt_mem_if_nextgen_ddr3_controller_core.sv"               -work ng0                             
  ...
  vlog -sv                                   "$QSYS_SIMDIR/fpga_ddr3/altera_merlin_slave_translator.sv"                        -work s0_seq_debug_translator         
  vlog -sv                                   "$QSYS_SIMDIR/fpga_ddr3/altera_merlin_master_translator.sv"                       -work dmaster_master_translator       
  vlog -sv                                   "$QSYS_SIMDIR/fpga_ddr3/altera_mem_if_dll_cyclonev.sv"                            -work dll0                            
  vlog -sv                                   "$QSYS_SIMDIR/fpga_ddr3/altera_mem_if_oct_cyclonev.sv"                            -work oct0                            
  ...
  vlog -sv                                   "$QSYS_SIMDIR/fpga_ddr3/altera_mem_if_sequencer_mem_no_ifdef_params.sv"           -work s0                              
  vlog -sv                                   "$QSYS_SIMDIR/fpga_ddr3/altera_merlin_arbitrator.sv"                              -work s0                              
  vlog -sv                                   "$QSYS_SIMDIR/fpga_ddr3/altera_merlin_burst_uncompressor.sv"                      -work s0                              
  vlog -sv                                   "$QSYS_SIMDIR/fpga_ddr3/altera_merlin_master_agent.sv"                            -work s0                              
  vlog -sv                                   "$QSYS_SIMDIR/fpga_ddr3/altera_merlin_slave_agent.sv"                             -work s0                              
  vlog -sv                                   "$QSYS_SIMDIR/fpga_ddr3/altera_merlin_traffic_limiter.sv"                         -work s0                              
  vlog -sv                                   "$QSYS_SIMDIR/fpga_ddr3/fpga_ddr3_s0_addr_router.sv"                              -work s0                              
  vlog -sv                                   "$QSYS_SIMDIR/fpga_ddr3/fpga_ddr3_s0_addr_router_001.sv"                          -work s0                              
  vlog -sv                                   "$QSYS_SIMDIR/fpga_ddr3/fpga_ddr3_s0_addr_router_002.sv"                          -work s0                              
  vlog -sv                                   "$QSYS_SIMDIR/fpga_ddr3/fpga_ddr3_s0_cmd_xbar_demux.sv"                           -work s0                              
  vlog -sv                                   "$QSYS_SIMDIR/fpga_ddr3/fpga_ddr3_s0_cmd_xbar_demux_001.sv"                       -work s0                              
  vlog -sv                                   "$QSYS_SIMDIR/fpga_ddr3/fpga_ddr3_s0_cmd_xbar_demux_002.sv"                       -work s0                              
  vlog -sv                                   "$QSYS_SIMDIR/fpga_ddr3/fpga_ddr3_s0_cmd_xbar_mux_003.sv"                         -work s0                              
  vlog -sv                                   "$QSYS_SIMDIR/fpga_ddr3/fpga_ddr3_s0_cmd_xbar_mux_005.sv"                         -work s0                              
  vlog -sv                                   "$QSYS_SIMDIR/fpga_ddr3/fpga_ddr3_s0_id_router.sv"                                -work s0                              
  vlog -sv                                   "$QSYS_SIMDIR/fpga_ddr3/fpga_ddr3_s0_id_router_003.sv"                            -work s0                              
  vlog -sv                                   "$QSYS_SIMDIR/fpga_ddr3/fpga_ddr3_s0_id_router_005.sv"                            -work s0                              
  vlog -sv                                   "$QSYS_SIMDIR/fpga_ddr3/fpga_ddr3_s0_irq_mapper.sv"                               -work s0                              
  vlog -sv                                   "$QSYS_SIMDIR/fpga_ddr3/fpga_ddr3_s0_rsp_xbar_demux_003.sv"                       -work s0                              
  vlog -sv                                   "$QSYS_SIMDIR/fpga_ddr3/fpga_ddr3_s0_rsp_xbar_demux_005.sv"                       -work s0                              
  vlog -sv                                   "$QSYS_SIMDIR/fpga_ddr3/fpga_ddr3_s0_rsp_xbar_mux.sv"                             -work s0                              
  vlog -sv                                   "$QSYS_SIMDIR/fpga_ddr3/fpga_ddr3_s0_rsp_xbar_mux_001.sv"                         -work s0                              
  ...
  vlog -sv                                   "$QSYS_SIMDIR/fpga_ddr3/rw_manager_core.sv"                                       -work s0                              
  ...
  vlog -sv                                   "$QSYS_SIMDIR/fpga_ddr3/rw_manager_generic.sv"                                    -work s0                              
  ...
  vlog -sv                                   "$QSYS_SIMDIR/fpga_ddr3/sequencer_data_mgr.sv"                                    -work s0                              
  vlog -sv                                   "$QSYS_SIMDIR/fpga_ddr3/sequencer_phy_mgr.sv"                                     -work s0                              
  vlog -sv                                   "$QSYS_SIMDIR/fpga_ddr3/sequencer_reg_file.sv"                                    -work s0                              
  vlog                                       "$QSYS_SIMDIR/fpga_ddr3/sequencer_scc_acv_phase_decode.v"                         -work s0                              
  vlog -sv                                   "$QSYS_SIMDIR/fpga_ddr3/sequencer_scc_acv_wrapper.sv"                             -work s0                              
  vlog -sv                                   "$QSYS_SIMDIR/fpga_ddr3/sequencer_scc_mgr.sv"                                     -work s0                              
  ...
  vlog -sv                                   "$QSYS_SIMDIR/fpga_ddr3/sequencer_scc_siii_wrapper.sv"                            -work s0                              
  vlog                                       "$QSYS_SIMDIR/fpga_ddr3/sequencer_scc_sv_phase_decode.v"                          -work s0                              
  vlog -sv                                   "$QSYS_SIMDIR/fpga_ddr3/sequencer_scc_sv_wrapper.sv"                              -work s0                              
  ...
  vlog -sv                                   "$QSYS_SIMDIR/fpga_ddr3/fpga_ddr3_p0_memphy.sv"                                   -work p0                              
  ...
  vlog -sv                                   "$QSYS_SIMDIR/fpga_ddr3/fpga_ddr3_p0_read_datapath.sv"                            -work p0                              
  vlog                                       "$QSYS_SIMDIR/fpga_ddr3/fpga_ddr3_p0_write_datapath.v"                            -work p0                              
  vlog -sv                                   "$QSYS_SIMDIR/fpga_ddr3/fpga_ddr3_p0_core_shadow_registers.sv"                    -work p0                              
  vlog -sv                                   "$QSYS_SIMDIR/fpga_ddr3/fpga_ddr3_p0_simple_ddio_out.sv"                          -work p0                              
  vlog -sv                                   "$QSYS_SIMDIR/fpga_ddr3/fpga_ddr3_p0_phy_csr.sv"                                  -work p0                              
  ...
  vlog -sv                                   "$QSYS_SIMDIR/fpga_ddr3/fpga_ddr3_p0.sv"                                          -work p0                              
  vlog                                       "$QSYS_SIMDIR/fpga_ddr3/fpga_ddr3_p0_altdqdqs.v"                                  -work p0                              
  vlog -sv                                   "$QSYS_SIMDIR/fpga_ddr3/altdq_dqs2_acv_cyclonev.sv"                               -work p0                              
  vlog -sv                                   "$QSYS_SIMDIR/fpga_ddr3/fpga_ddr3_pll0.sv"                                        -work pll0                            
