...
// 
// Generated using ACDS version 13.0 144 at 2013.04.07.17:35:33

`timescale 1 ps / 1 ps
module fpga_ddr3_dmaster #(
		parameter USE_PLI     = 0,
	...
	fpga_ddr3_dmaster_timing_adt timing_adt (
		.clk       (clk_clk),                                    //   clk.clk
	...
	fpga_ddr3_dmaster_b2p_adapter b2p_adapter (
		.clk               (clk_clk),                              //   clk.clk
		.reset_n           (~rst_controller_reset_out_reset),      // reset.reset_n
	...
	fpga_ddr3_dmaster_p2b_adapter p2b_adapter (
		.clk               (clk_clk),                            //   clk.clk
		.reset_n           (~rst_controller_reset_out_reset),    // reset.reset_n
