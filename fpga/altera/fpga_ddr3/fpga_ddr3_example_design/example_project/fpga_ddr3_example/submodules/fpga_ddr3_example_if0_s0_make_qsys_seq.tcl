...
lappend arg_list "--component-param=SEQ_ROM=fpga_ddr3_example_if0_s0_sequencer_mem.hex"
lappend arg_list "--component-param=RAM_BLOCK_TYPE=AUTO"
lappend arg_list "--component-param=AC_ROM_INIT_FILE_NAME=fpga_ddr3_example_if0_s0_AC_ROM.hex"
lappend arg_list "--component-param=INST_ROM_INIT_FILE_NAME=fpga_ddr3_example_if0_s0_inst_ROM.hex"
...
lappend arg_list "--output-name=fpga_ddr3_example_if0_s0"
lappend arg_list "--system-info=DEVICE_FAMILY=CYCLONEV"
lappend arg_list "--report-file=sopcinfo:fpga_ddr3_example_if0_s0.sopcinfo"
lappend arg_list "--report-file=txt:fpga_ddr3_example_if0_s0_seq_ipd_report.txt"
lappend arg_list "--file-set=QUARTUS_SYNTH"
catch { eval [concat [list exec "/opt/altera/13.1/quartus/sopc_builder/bin/ip-generate" --component-name=qsys_sequencer_110] $arg_list] } temp
puts $temp
