...
lappend arg_list "--report-file=csv:fpga_ddr3_example.csv"
lappend arg_list "--report-file=qip:fpga_ddr3_example.qip"
lappend arg_list "--output-name=fpga_ddr3_example"
...
lappend arg_list "--component-param=SPEED_GRADE=8"
...
catch { eval [concat [list exec "/home/zhehao/misc/altera/13.1/quartus//sopc_builder/bin/ip-generate" --component-name=alt_mem_if_ddr3_tg_ed] $arg_list] } temp
puts $temp
