...
add_interface_port conduit_end pause_n export Output 1
add_interface_port conduit_end resume export Output 1
add_interface_port conduit_end waiting export Input 1
